...
send_message "<b>RKHunter (последние строки):<b>"

        PSAD_STATUS=$(sudo psad -S | head -n 20 || echo "Ошибка запуска psad -S")

send_message "<b>Статус PSAD:<b><br><br>$PSAD_STATUS<br>"
...
send_message "<b>Top IP-адреса с угрозами:<b><br><br>$TOP_IPS<br>"
\\\
$RKHUNTER_RESULT
\\\
